...
建立「是什么、能做什么」的印象后，下面说明**怎么学更高效**、LangChain **长什么样**（版本与六大模块）。入门阶段重点看 **1.3.3 六大核心模块**，其余了解即可。
...
- 不必追求「学完所有 API」，重点搞懂 **六大核心模块**（Models、Memory、Retrieval、Chains、Agents、Callback）的逻辑与用法。

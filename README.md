...
| 章节 | 内容概要                                                                                     | 更新情况 |
| ---- | -------------------------------------------------------------------------------------------- | -------- |
| 01-1 | 大模型（LLM）认识与环境准备：起源与发展、AGI 关系、主流模型特点与适用场景、预训练/微调/推理  | 已更新   |
| 01-2 | 大模型架构原理：Transformer、MoE、自注意力、LLaMA/Qwen/GPT、多模态                           | 已更新   |
| 01-3 | 大模型调度平台：Ollama、私有大模型调用、云端/本地部署（AWS、阿里云等）                       | 已更新   |
| 01-4 | 提示词工程：核心原则与结构、链式思维与 Few-shot、多轮对话与记忆、在 Agent 与工具调用中的应用 | 已更新   |

### 02 企业低代码平台开发与项目实战

| 章节 | 内容概要                                                                                         | 更新情况 |
| ---- | ------------------------------------------------------------------------------------------------ | -------- |
| 02-1 | Coze（扣子）平台：界面与功能、插件/知识库/工作流/智能体、Python 调用工作流                       | 已更新   |
| 02-2 | 项目 1：商户运营管家（行业调研 PPT、爆款视频复刻、营销海报、卖点提炼、评论分析）                 | 待更新   |
| 02-3 | Dify AI 平台：工作流/Agent/知识库、多案例（投诉分类、调研报告、客服分析、评论分析）、Python 调用 | 已更新   |
...
| 章节 | 内容概要                                                                                | 更新情况 |
| ---- | --------------------------------------------------------------------------------------- | -------- |
| 03-1 | LangChain：Model I/O、Chains、Memory、Agents（ReAct）、Retrieval、电商商家对话助手案例  | 待更新   |
| 03-2 | LangGraph：图状思维、State/Node/Edge、持久化记忆、流式输出                              | 待更新   |
...
| 05-3 | Llama-Factory 高效微调：环境与参数、单卡/多卡、Safetensors/ONNX                                          | 待更新   |
...
**仓库英文名**：`i-agents-from-zero` · **教程**：《AI 大模型智能体从入门到精通》
